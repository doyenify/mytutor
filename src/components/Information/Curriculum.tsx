  ...
  return (
    ...
    <div className={showcatalogbox ? "showcatalogbox": "hidecatalogbox"}>                                
      ...
      <div className="text-center" onClick={showCatalog} style={{marginBottom: "10px", cursor: "pointer"}}>
        ...
        <hr/>
      <strong> <h6 className='mb-3' style={{backgroundColor:"#FBDC6E", color: "#3F556B", padding: "6px", borderRadius: "6px"}}>Eesti Keele Õppekava</h6> </strong>
       ...
       <strong> <h6  className='mb-3' style={{backgroundColor:"#FBDC6E", color: "#3F556B", padding: "6px", borderRadius: "6px"}}>Inglise Keele Õppekava</h6> </strong>
        <div className="tabtext d-flex flex-column">
